...
export default function AboutIntro() {
  return (
    <div className="relative flex items-center justify-end px-24 h-screen">
      <div className="w-[600px] backdrop-blur-lg py-12 px-8 absolute top-1/2 left-[7rem] transform  -translate-y-1/2">
